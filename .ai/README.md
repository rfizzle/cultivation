...
| `agents/` | Role prompts, **vendored from concord** — same sync. |
...
Domain-specific review emphasis (e.g. the crop-drop choke point that every
harvest actor flows through, and chunk soil-attachment serialization) lives in
