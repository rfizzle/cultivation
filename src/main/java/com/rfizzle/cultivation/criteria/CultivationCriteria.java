package com.rfizzle.cultivation.criteria;
 ...
 * {@code mc-advancements}). Each of the four Husbandry-tab advancements is a
 ...
 * nine crops fell to one sweep, a crop came off enriched-and-dosed soil) is
 * decided at the fire site and the trigger simply grants when fired.
 *
